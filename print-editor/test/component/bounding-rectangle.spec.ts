...
describe("Bounding rectangle tests", function () {
    ...
    it("should consider element with origin (250, 100) and size (150, 100) within", function () {
        expect(bounds.within(point(250, 100), size(150, 100), converter)).toBeTruthy();
    });

    it("should consider element with origin (500, 300) and size (150, 100) not within", function () {
        expect(bounds.within(point(500, 300), size(150, 100), converter)).toBeFalsy();
    });

    it("should consider element with origin (500, 300) and size (150, 100) not within width", function () {
        expect(bounds.withinWidth(point(500, 300), size(150, 100), converter)).toBeFalsy();
    });

    it("should consider element with origin (500, 300) and size (150, 100) not within height", function () {
        expect(bounds.withinHeight(point(500, 300), size(150, 100), converter)).toBeFalsy();
    });

    it("should consider element with origin (500, 300) and size (150, 100) within height with special y resolver",
       function () {
           expect(bounds.withinHeight(point(500, 300), size(150, 100), converter, (position) => {
